...
export default class TraitSelector extends BaseConfigSheet {
  constructor(actor, trait, options={}) {
    if ( !CONFIG.DND5A.traits[trait] ) throw new Error(
      `Cannot instantiate TraitSelector with a trait not defined in CONFIG.DND5A.traits: ${trait}.`
    );
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      id: "trait-selector",
      classes: ["dnd5a", "trait-selector", "subconfig"],
      template: "systems/dnd5a/templates/apps/trait-selector.hbs",
      width: 320,
      height: "auto",
      allowCustom: true
    });
  ...
  async getData() {
    ...
    return {
      ...
      bypasses: "bypasses" in data ? Object.entries(CONFIG.DND5A.itemProperties).reduce((obj, [k, v]) => {
