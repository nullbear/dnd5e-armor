...
export default class PropertyAttribution extends Application {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      classes: ["dnd5a", "property-attribution"],
      template: "systems/dnd5a/templates/apps/property-attribution.hbs",
      width: 320,
      height: "auto"
    });
  }
  ...
  getPropertyLabel(property) {
    ...
    if ( parts[0] === "abilities" && parts[1] ) {
      return CONFIG.DND5A.abilities[parts[1]]?.label ?? property;
    } else if ( (property === "attributes.ac.dex") && CONFIG.DND5A.abilities.dex ) {
      return CONFIG.DND5A.abilities.dex.label;
    } else if ( (parts[0] === "prof") || (property === "attributes.prof") ) {
      return game.i18n.localize("DND5A.Proficiency");
    }
    return property;
  }
}
